    ...
    <div className="development-container">
        ...
        <div className="sidebar-overlay" onClick={toggleSidebar}>
          <div className="mobile-sidebar" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mobile-sidebar-menu">
              ...
              <Link to="/development" className="mobile-menu-item active">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <rect x="3" y="3" width="7" height="7"></rect>
                  <rect x="14" y="3" width="7" height="7"></rect>
                  <rect x="14" y="14" width="7" height="7"></rect>
      ...
      <div className="development-content">
        ...
        <aside className="development-sidebar">
          ...
          <Link to="/schedule" className="sidebar-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <circle cx="12" cy="12" r="10"></circle>
              <polyline points="12,6 12,12 16,14"></polyline>
            </svg>
          </Link>
          <Link to="/news" className="sidebar-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path>
              <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path>
            </svg>
        ...
        <main className="development-main">
          ...
          <div className="development-actions-section">
            <button className="add-projects-btn">
