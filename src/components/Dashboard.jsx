      ...
      <header className="dashboard-header">
        ...
        <div className="header-right">
          <div className="header-icon notification-icon">
            <img src={notificationIconImg} alt="Notifications" style={{ width: 20, height: 20, objectFit: 'contain' }} />
            <div className="notification-dot"></div>
          </div>
          <div className="header-icon profile-icon" onClick={toggleProfileDropdown} ref={profileRef}>
            <img src={profileIconImg} alt="Profile" style={{ width: 20, height: 20, objectFit: 'contain' }} />
              ...
              <div className="summary-cards-row">
                <div className="summary-card active-voters">
                  <div className="card-icon">
                    <img src={activeVotersIcon} alt="Active Voters" style={{ width: 40, height: 40, objectFit: 'contain' }} />
                  </div>
                ...
                <div className="summary-card ongoing-process">
                  <div className="card-icon">
                    <img src={ongoingProcessIcon} alt="Ongoing Process" style={{ width: 40, height: 40, objectFit: 'contain' }} />
                  </div>
                  <div className="card-content">
